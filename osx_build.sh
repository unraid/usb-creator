...
#/Users/$USER/Qt/5.11.2-static/bin/lrelease creator.pro

echo ""
echo "Running qmake..."
/Users/$USER/Qt/5.11.2-static/bin/qmake
...
#/Users/$USER/Qt/5.11.2-static/bin/macdeployqt "Unraid USB Creator.app" -no-plugins
