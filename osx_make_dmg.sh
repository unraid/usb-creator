...
/Users/$USER/Qt/6.3.1-static/bin/macdeployqt "Unraid USB Creator.app" -no-plugins -no-strip -dmg -codesign="Developer ID Application: Lime Technology Inc. (B4L35Y5N35)" -timestamp -sign-for-notarization="Developer ID Application: Lime Technology Inc. (B4L35Y5N35)" -verbose=2
